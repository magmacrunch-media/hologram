...
set PURE=source\linalg.c source\polar.c source\geometry.c source\camera.c source\collision.c source\cpu_trace.c source\gpu_scene.c source\spectrum.c source\timestep.c
